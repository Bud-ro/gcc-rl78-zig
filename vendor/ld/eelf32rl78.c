...
gldelf32rl78_before_plugin_all_symbols_read (void)
{
  ldelf_before_plugin_all_symbols_read (true, false,
				        false,
					false,
					32, "/home/carson/git/gcc-rl78-zig/zig-out/rl78-elf");
}
...
gldelf32rl78_after_open (void)
{
  ldelf_after_open (true, false,
		    false, false, 32, "/home/carson/git/gcc-rl78-zig/zig-out/rl78-elf");
}
...
OUTPUT_ARCH(rl78)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/home/carson/git/gcc-rl78-zig/zig-out/rl78-elf/rl78-elf/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
