...
#include "config/rl78/rl78-opts.h"
...
#endif
#ifdef GENERATOR_FILE
extern enum rl78_cpu_types rl78_cpu_type;
#else
  enum rl78_cpu_types x_rl78_cpu_type;
#define rl78_cpu_type global_options.x_rl78_cpu_type
#endif
#ifdef GENERATOR_FILE
extern enum rl78_mul_types rl78_mul_type;
#else
  enum rl78_mul_types x_rl78_mul_type;
#define rl78_mul_type global_options.x_rl78_mul_type
#endif
#ifdef GENERATOR_FILE
...
#define MASK_ALLREGS (1U << 0)
#define MASK_ES0 (1U << 1)
#define MASK_SAVE_MDUC_REGISTERS (1U << 2)

/* ALLREGS mask */
#define TARGET_ALLREGS ((target_flags & MASK_ALLREGS) != 0)
#define TARGET_ALLREGS_P(target_flags) (((target_flags) & MASK_ALLREGS) != 0)
#define TARGET_ALLREGS_OPTS_P(opts) (((opts->x_target_flags) & MASK_ALLREGS) != 0)
#define TARGET_EXPLICIT_ALLREGS_P(opts) ((opts->x_target_flags_explicit & MASK_ALLREGS) != 0)
#define SET_TARGET_ALLREGS(opts) opts->x_target_flags |= MASK_ALLREGS
/* ES0 mask */
#define TARGET_ES0 ((target_flags & MASK_ES0) != 0)
#define TARGET_ES0_P(target_flags) (((target_flags) & MASK_ES0) != 0)
#define TARGET_ES0_OPTS_P(opts) (((opts->x_target_flags) & MASK_ES0) != 0)
#define TARGET_EXPLICIT_ES0_P(opts) ((opts->x_target_flags_explicit & MASK_ES0) != 0)
#define SET_TARGET_ES0(opts) opts->x_target_flags |= MASK_ES0
/* SAVE_MDUC_REGISTERS mask */
#define TARGET_SAVE_MDUC_REGISTERS ((target_flags & MASK_SAVE_MDUC_REGISTERS) != 0)
#define TARGET_SAVE_MDUC_REGISTERS_P(target_flags) (((target_flags) & MASK_SAVE_MDUC_REGISTERS) != 0)
#define TARGET_SAVE_MDUC_REGISTERS_OPTS_P(opts) (((opts->x_target_flags) & MASK_SAVE_MDUC_REGISTERS) != 0)
#define TARGET_EXPLICIT_SAVE_MDUC_REGISTERS_P(opts) ((opts->x_target_flags_explicit & MASK_SAVE_MDUC_REGISTERS) != 0)
#define SET_TARGET_SAVE_MDUC_REGISTERS(opts) opts->x_target_flags |= MASK_SAVE_MDUC_REGISTERS
...
enum opt_code
{
  ...
  /* OPT_mg14 = 1960, */                     /* -mg14 */
  OPT_mmul_ = 1961,                          /* -mmul= */
  OPT_mrelax = 1962,                         /* -mrelax */
  /* OPT_mrl78 = 1963, */                    /* -mrl78 */
  OPT_msave_mduc_in_interrupts = 1964,       /* -msave-mduc-in-interrupts */
  OPT_msim = 1965,                           /* -msim */
  OPT_n = 1966,                              /* -n */
