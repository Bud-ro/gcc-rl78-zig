  ...
  switch (option_index)
    {
     ...
     case OPT_list:
       break;
     case OPT_mallregs:
       return "gcc/RL78-Options.html#index-mallregs";
     case OPT_mcpu_:
       return "gcc/RL78-Options.html#index-mcpu-9";
     case OPT_mes0:
       break;
     case OPT_mmul_:
       return "gcc/RL78-Options.html#index-mmul";
     case OPT_mrelax:
       break;
     case OPT_msave_mduc_in_interrupts:
       return "gcc/RL78-Options.html#index-msave-mduc-in-interrupts";
     case OPT_msim:
       return "gcc/RL78-Options.html#index-msim-6";
     case OPT_n:
       break;
     case OPT_name_sort:
       break;
